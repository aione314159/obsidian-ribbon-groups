...
![左リボンのグループ化とドラッグ中の状態。グループのタイトル、グループ、グループ外のボタン、ドラッグに注釈](./docs/images/ribbon.ja.png)
...
![グループ外のボタンを隠す、グループの表示切り替え、背景色、移動先グループ、グループの削除に注釈を付けた設定画面](./docs/images/settings.ja.png)
